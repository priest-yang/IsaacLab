...
from rsl_rl.modules import ActorCriticLerobot
from rsl_rl.modules.rnd import RandomNetworkDistillation
from rsl_rl.storage import RolloutStorageLerobot
...
class PPOLerobot:
    ...
    actor_critic: ActorCriticLerobot
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.storage: RolloutStorageLerobot = None  # type: ignore
        self.transition = RolloutStorageLerobot.Transition()
    ...
    def init_storage(self, num_envs, num_transitions_per_env, actor_obs_shape, critic_obs_shape, action_shape):
        ...
        # create rollout storage
        self.storage = RolloutStorageLerobot(
            num_envs,
