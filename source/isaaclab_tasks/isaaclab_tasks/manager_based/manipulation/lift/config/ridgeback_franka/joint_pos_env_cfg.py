...
@configclass
class FrankaRidgeCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        # post init of parents
        super().__post_init__()

        # Set Franka as robot
        self.scene.robot = RIDGEBACK_FRANKA_PANDA_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class FrankaRidgeCubeLiftEnvCfg_PLAY(FrankaRidgeCubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
