...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    kitchen = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.72, -0.2, 0], rot=[1, 0, 0, 0]),
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[1, 0, 0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(usd_path=r'C:\Academic\Umich\ROB599DLRP\Project\final\ws\IsaacLab\source\isaaclab_assets\data\KitchenRoom_small.usd'),
    )
    ...
    #     init_state=AssetBaseCfg.InitialStateCfg(pos=[0.7379, -0.2, 0.9], rot=[-0.70710678, 0.70710678, 0.0, 0.0]),
    #     spawn=UsdFileCfg(
    #         usd_path="https://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/Isaac/4.5/Isaac/Props/YCB/Axis_Aligned/024_bowl.usd"
    #     ),
    # )
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=4, env_spacing=10)
    # Basic settings
